    ...
    public function payment()
    {
        ...
        */
        if (isset($_POST['pay']) || isset($_POST['installment']) || isset($_POST['cardpayment'])) {
            $token = $this->getToken(1006, '581ba5eeadd657c8ccddc74c839bd3ad');
            if(isset($_POST['pay'])){
                $intent = 'CAPTURE';
            ...
            $response = $this->makeOrder($token, $intent, 'http://192.168.64.2/profile', 'ka', true, $items, null, null, $totalAmout, $orderCode);
